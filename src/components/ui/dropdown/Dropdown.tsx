...
import {
    useBreakpoint,
    type BreakpointKey,
} from '@/models/hooks/useBreakpoint';
import {
    getComponentColor,
    type ComponentColor,
    ...
    return (
        <>
            ...
            >
                ...
                <span className={cn('dropdown-arrow', open && 'rotate')}>
                    ▾
                </span>
            </button>
        </>
 ...
 * 🟦 ITEM
 * ============================================================ */
interface IDropdownItemProps extends ComponentProps<'button'> {
    variant?: ComponentVariant;
    inset?: boolean;
}
 ...
 * 🟦 SUBTRIGGER
 * ============================================================ */
interface IDropdownSubTriggerProps extends ComponentProps<'button'> {
    open?: boolean;
...
export const DropdownSubTrigger = ({
    ...
    return (
        <>
            ...
            >
                <span>{children}</span>
                <span className={cn('dropdown-sub-arrow', open && 'rotate')}>
                    ▸
                </span>
            </button>
        </>
 ...
 * 🟦 SUBCONTENT
 * ============================================================ */
interface IDropdownSubContentProps extends ComponentProps<'div'> {
    open?: boolean;
}
...
function dropdownTransformer(
    ...
    if (
        elementType === DropdownSubTrigger ||
        elementType === DropdownSubContent
    ) {
        return {
