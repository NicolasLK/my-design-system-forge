...
export const DateRangePicker = ({
    ...
    const handleSelect = (date: Date) => {
        ...
        if (step === "start" || (currentStart && selectedDate.getTime() < currentStart.getTime())) {
        ...
        if (newStart) {
            ...
            const currentMonthTime = normalizeDate(visibleMonth)?.getTime() || 0;
            ...
            >
                <div className="range-header">
                    <div
                        ...
                        className={cn("range-display", step === "start" && "range-active")}
                    >
                    ...
                    <div
                        ...
                        className={cn("range-display", step === "end" && "range-active")}
                    >
